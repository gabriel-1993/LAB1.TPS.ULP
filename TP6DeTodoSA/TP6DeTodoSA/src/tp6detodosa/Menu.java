...
//quitamos todo lo que este mostrando escritorio
    ...
    private void cargarProductos() {
        ...
        listaProductos.add(new Producto(1013, "Detergente 500Cc", 700, 35, Categoria.LIMPIEZA));
        listaProductos.add(new Producto(1014, "Lavandina 1L", 400.50, 17, Categoria.LIMPIEZA));
        listaProductos.add(new Producto(1015, "Trapo de piso Gris", 500, 95, Categoria.LIMPIEZA));
        listaProductos.add(new Producto(1020, "Colonia 500Cc", 750, 10, Categoria.PERFUMERIA));
        listaProductos.add(new Producto(1021, "Desodorante 500cc", 600.70, 302, Categoria.PERFUMERIA));
        listaProductos.add(new Producto(1023, "Shampoo 500Cc", 1200, 43, Categoria.PERFUMERIA));
